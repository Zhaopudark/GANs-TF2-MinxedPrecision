...
"""
global_input_X_shape = [1,64,64,64,1]
global_input_Y_shape = [1,64,64,64,1]
################################################
class CycleGAN(tf.keras.Model):
    ...
    def get_seed(self):
        ...
        plt.imshow(seed[0][0,:,:,32,0],cmap='gray')
        plt.show()
        plt.imshow(seed[1][0,:,:,32,0],cmap='gray')
        plt.show()
        self.seed = seed 
    ...
    def wirte_summary(self,step,seed,G,F,G_loss,Dy_loss,F_loss,Dx_loss,out_path):
        ...
        plt.subplot(2,2,1)
        plt.title('real X')
        plt.imshow(testX[0,:,:,32,0],cmap='gray')
        plt.axis('off')
        plt.subplot(2,2,2)
        plt.title('fake Y')
        plt.imshow(GeneratedY[0,:,:,32,0],cmap='gray')
        plt.axis('off')
        plt.subplot(2,2,3)
        plt.title('fake X')
        plt.imshow(GeneratedX[0,:,:,32,0],cmap='gray')
        plt.axis('off')
        plt.subplot(2,2,4)
        plt.title('real Y')
        plt.imshow(testY[0,:,:,32,0],cmap='gray')
        plt.axis('off')
