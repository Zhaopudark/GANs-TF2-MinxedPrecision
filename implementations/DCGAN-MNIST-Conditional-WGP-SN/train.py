...
test_path = None
tmp_path = "D:/Work/Codes_tmp/DCGAN-Conditional-mixed-MNIST-wgp-sn"
out_path = "D:/Work/Codes_tmp/DCGAN-Conditional-mixed-MNIST-wgp-sn/out"
...
def map_func(img,label):
    ...
    Conditional GAN 引入条件 此处以one_hot 标签为条件
    """
...
model = model.DCGAN(train_set=dataset,
                       ...
                       tmp_path=tmp_path,
                       out_path=out_path)
model.build(input_shape_G=[None,100],input_shape_D=[None,28,28,1],label_shape=[None,10])
