...
if __name__ == "__main__":
    ...
    a = vec2img(5*7*256)#160 196 3 //10 14 256
    a.build(input_shape=[None,256])
    w = tf.random.normal([128,256])
    y = a(w)
    print(y.shape)
    print(y.dtype)
    print(len(a.trainable_variables))
    a = uk_5s1_2D(128)
    a.build(input_shape=[None,5,7,256])
    y = a(tf.reshape(y,[-1,5,7,256]))
    print(y.shape)
    print(y.dtype)
    print(len(a.trainable_variables))

    a = uk_5s2_2D(64)
    a.build(input_shape=[None,5,7,128])
    y = a(y)
    print(y.shape)
    print(y.dtype)
    print(len(a.trainable_variables))
    ...
    a = lats_up(1)
    a.build(input_shape=[None,10,14,64])
    y = a(y)
    print(y.shape)
    print(y.dtype)
    print(len(a.trainable_variables))
    ...
    a = ckd_5s2_2D(64)
    a.build(input_shape=[None,20,28,1])
    y = a(y)
    print(y.shape)
    print(y.dtype)
    print(len(a.trainable_variables))
